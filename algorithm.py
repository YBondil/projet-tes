...
class Matching:
    ...
    def __init__(self, hashes1, hashes2):
        ...
        self.is_match = self.max_count > 10  # seuil à ajuster selon les résultats
...
#test = Encoding('./samples/654.wav', window=128, temporal_window=1., overlap=32)
#test.spectrogramm_calc()
#test.display_spectrogram(display_anchors = False)